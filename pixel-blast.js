const { Effect, EffectComposer, EffectPass, RenderPass } = window.postprocessing || {};
...
window.initPixelBlast = function(containerId, overrideConfig = {}) {
  ...
  const config = {
    variant: 'square',
    pixelSize: 3,
    color: '#00f0ff', // Match techNova neon blue
    antialias: true,
    patternScale: 2,
    patternDensity: 1.5,
    liquid: true,
